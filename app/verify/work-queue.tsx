    ...
    <section className="queue-page" aria-label="Label verification work queue">
      <header className="queue-hero">
        ...
        <div className="queue-hero-actions">
          ...
          {catalogConfigured && <button className="queue-catalog-button" type="button" onClick={onCatalogImport}>
            ...
            <div className="queue-empty">
              ...
              {!cases.length && (
                <div className="queue-empty-actions">
                  ...
                  {catalogConfigured && <button type="button" onClick={onCatalogImport}>Import from catalog</button>}
                </div>
              )}
            </div>
          ) : filtered.map((item) => {
